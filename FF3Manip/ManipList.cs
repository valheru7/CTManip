    ...
    public class ManipList
    {
        ...
        public ManipList()
        {
            manipNameToFunc = new Dictionary<ManipNames, Func<Manip>>
            {
                ...
                {ManipNames.SealedCave, DragonsPeak},
                {ManipNames.SealedCave, TowerOfOwen},
                {ManipNames.SealedCave, TowenOfOwen2},
                {ManipNames.SealedCave, SubterraneanLake},
                {ManipNames.SealedCave, MoltenCave},
                {ManipNames.SealedCave, HeinCastle},
                {ManipNames.SealedCave, CaveOfTides},
                {ManipNames.SealedCave, Sewers},
                {ManipNames.SealedCave, Amur},
            };
        }
